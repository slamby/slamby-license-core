...
﻿namespace Slamby.License.Core
{
    ...
    public interface ILicenseBuilder : IFluentInterface
    {
        ...
        ILicenseBuilder WithUniqueIdentifier(string id);
        ...
        /// </summary>
        /// <param name="cores">The maximum cores of the <see cref="License"/>.</param>
        /// <returns>The <see cref="ILicenseBuilder"/>.</returns>
        ILicenseBuilder WithCores(int utilization);
        ...
        /// <returns>The <see cref="ILicenseBuilder"/>.</returns>
        ILicenseBuilder LicensedTo(string email);
        ...
        /// <returns>The <see cref="ILicenseBuilder"/>.</returns>
        ILicenseBuilder LicensedTo(string name, string email, string company);
