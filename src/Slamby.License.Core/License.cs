...
using Slamby.License.Core.Security.Cryptography;
...
namespace Slamby.License.Core
{
    ...
    public class License
    {
        ...
        public string Id
        {
            get { return GetTag("Id") ?? string.Empty; }
            set { if (!IsSigned) SetTag("Id", value); }
        }
        ...
        public LicenseType Type
        {
            get
            {
                return
                    (LicenseType)
                    Enum.Parse(typeof (LicenseType), GetTag("Type") ?? LicenseType.OpenSource.ToString(), false);
            }
            set { if (!IsSigned) SetTag("Type", value.ToString()); }
        }

        /// <summary>
        /// Get or sets the core number of this license.
        /// </summary>
        public int Cores
        {
            get { return int.Parse(GetTag("Cores") ?? "0"); }
            set { if (!IsSigned) SetTag("Cores", value.ToString()); }
        }
